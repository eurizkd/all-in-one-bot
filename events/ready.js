...
module.exports = {
    ...
    execute(client) {
        ...
        const activities = [
            { name: 'Lille RolePlay', type: ActivityType.Watching },
            { name: 'V2 le 15 février', type: ActivityType.Playing },
            { name: 'Lille Roleplay', type: ActivityType.Streaming },
            { name: 'Lille Roleplay', type: ActivityType.Listening },
        ];
